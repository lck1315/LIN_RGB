...
typedef struct {
  ...
  volatile unsigned long  bd                            :   11;       /* [15:5] */
  volatile unsigned long  bdfa                          :    5;       /* [ 4:0] */
#else
...
typedef struct {
  ...
  volatile unsigned long  tie                           :    1;       /* [7] */
  volatile unsigned long  lin                           :    1;       /* [6] */
  volatile unsigned long  rie                           :    1;       /* [5] */
  volatile unsigned long  bie                           :    1;       /* [4] */
  volatile unsigned long  te                            :    1;       /* [3] */
  volatile unsigned long  re                            :    1;       /* [2] */
  volatile unsigned long  mfie                          :    1;       /* [1] */
  volatile unsigned long  sbk                           :    1;       /* [0] */
#else
...
#define MSK_SCI_STATUS_BRF                                  (0x1)     /* [0] */
#define SFT_SCI_STATUS_BRF                                  (0)
#define BIT_SCI_STATUS_BRF                                  (0x1)     /* [0] */
...
#define MSK_SCI_STATUS_FE                                   (0x1)     /* [4] */
#define SFT_SCI_STATUS_FE                                   (4)
#define BIT_SCI_STATUS_FE                                   (0x10)    /* [4] */
...
typedef struct {
  ...
  volatile unsigned long  abt                           :    1;       /* [9] */
  volatile unsigned long  amt                           :    1;       /* [8] */
  volatile unsigned long  tdre                          :    1;       /* [7] */
  volatile unsigned long  tc                            :    1;       /* [6] */
  volatile unsigned long  rdrf                          :    1;       /* [5] */
  volatile unsigned long  fe                            :    1;       /* [4] */
  volatile unsigned long  ov                            :    1;       /* [3] */
  volatile unsigned long  mrun                          :    1;       /* [2] */
  volatile unsigned long  mf                            :    1;       /* [1] */
  volatile unsigned long  brf                           :    1;       /* [0] */
#else
  volatile unsigned short brf                           :    1;       /* [0] */
  volatile unsigned short mf                            :    1;       /* [1] */
  volatile unsigned short mrun                          :    1;       /* [2] */
  volatile unsigned short ov                            :    1;       /* [3] */
  volatile unsigned short fe                            :    1;       /* [4] */
...
typedef struct {
#ifdef SPARC
  volatile unsigned long  reserved                      :   18;
  volatile unsigned long  dbc                           :    6;       /* [13:8] */
  volatile unsigned long  reserved7                     :    3;       /* [ 7:5] */
  volatile unsigned long  bus_collision_e               :    1;       /* [4] */
  volatile unsigned long  auto_baud                     :    1;       /* [3] */
  volatile unsigned long  auto_meas                     :    1;       /* [2] */
  volatile unsigned long  mmode                         :    1;       /* [1] */
  volatile unsigned long  men                           :    1;       /* [0] */
#else
...
#ifdef SPARC
  volatile unsigned long  reserved                      :   24;
  volatile unsigned long  version                       :    4;       /* [ 7:4] */
  volatile unsigned long  dma                           :    1;       /* [3] */
  volatile unsigned long  timer                         :    1;       /* [2] */
  volatile unsigned long  txd_timeout_reg               :    1;       /* [1] */
  volatile unsigned long  cbm                           :    1;       /* [0] */
#else
...
#define MSK_SCI_LIN_MODE_TIMER_PREPARE                      (0x1)     /* [5] */
#define SFT_SCI_LIN_MODE_TIMER_PREPARE                      (5)
#define BIT_SCI_LIN_MODE_TIMER_PREPARE                      (0x20)    /* [5] */
#define MSK_SCI_LIN_MODE_TXD_TIMEOUT_ENABLE                 (0x1)     /* [6] */
#define SFT_SCI_LIN_MODE_TXD_TIMEOUT_ENABLE                 (6)
#define BIT_SCI_LIN_MODE_TXD_TIMEOUT_ENABLE                 (0x40)    /* [6] */

typedef struct {
#ifdef SPARC
  volatile unsigned long  reserved                      :   25;
  volatile unsigned long  txd_timeout_enable            :    1;       /* [6] */
  volatile unsigned long  timer_prepare                 :    1;       /* [5] */
  volatile unsigned long  timer_enable                  :    1;       /* [4] */
  volatile unsigned long  high_speed                    :    1;       /* [3] */
  volatile unsigned long  sci_disable                   :    1;       /* [2] */
  volatile unsigned long  txd_val                       :    1;       /* [1] */
  volatile unsigned long  rxd                           :    1;       /* [0] */
#else
  ...
  volatile unsigned short timer_prepare                 :    1;       /* [5] */
  volatile unsigned short txd_timeout_enable            :    1;       /* [6] */
...
#define MSK_SCI_ADDON_INTERRUPT_ENABLE_RXD_RISING_IRQ_E     (0x1)     /* [0] */
#define SFT_SCI_ADDON_INTERRUPT_ENABLE_RXD_RISING_IRQ_E     (0)
#define BIT_SCI_ADDON_INTERRUPT_ENABLE_RXD_RISING_IRQ_E     (0x1)     /* [0] */
#define MSK_SCI_ADDON_INTERRUPT_ENABLE_RXD_FALLING_IRQ_E    (0x1)     /* [1] */
#define SFT_SCI_ADDON_INTERRUPT_ENABLE_RXD_FALLING_IRQ_E    (1)
#define BIT_SCI_ADDON_INTERRUPT_ENABLE_RXD_FALLING_IRQ_E    (0x2)     /* [1] */
...
#ifdef SPARC
  volatile unsigned long  reserved                      :   24;
  volatile unsigned long  lin_bus_collision_irq_e       :    1;       /* [7] */
  volatile unsigned long  rx_dma_finished_irq_e         :    1;       /* [6] */
  volatile unsigned long  tx_dma_finished_irq_e         :    1;       /* [5] */
  volatile unsigned long  sci_timer_ov_irq_e            :    1;       /* [4] */
  volatile unsigned long  sci_timer_cmp_irq_e           :    1;       /* [3] */
  volatile unsigned long  txd_timeout_irq_e             :    1;       /* [2] */
  volatile unsigned long  rxd_falling_irq_e             :    1;       /* [1] */
  volatile unsigned long  rxd_rising_irq_e              :    1;       /* [0] */
#else
  volatile unsigned short rxd_rising_irq_e              :    1;       /* [0] */
  volatile unsigned short rxd_falling_irq_e             :    1;       /* [1] */
...
#ifdef SPARC
  volatile unsigned long  reserved                      :   24;
  volatile unsigned long  lin_bus_collision             :    1;       /* [7] */
  volatile unsigned long  rx_dma_finished               :    1;       /* [6] */
  volatile unsigned long  tx_dma_finished               :    1;       /* [5] */
  volatile unsigned long  sci_timer_ov                  :    1;       /* [4] */
  volatile unsigned long  sci_timer_cmp                 :    1;       /* [3] */
  volatile unsigned long  txd_timeout                   :    1;       /* [2] */
  volatile unsigned long  rxd_rising                    :    1;       /* [1] */
  volatile unsigned long  rxd_falling                   :    1;       /* [0] */
#else
...
typedef struct {
  ...
  volatile unsigned long  bus_collision                 :    1;       /* [11] */
  volatile unsigned long  rx_dma_finished               :    1;       /* [10] */
  volatile unsigned long  tx_dma_finished               :    1;       /* [9] */
  volatile unsigned long  sci_timer_ov                  :    1;       /* [8] */
  volatile unsigned long  sci_timer_cmp                 :    1;       /* [7] */
  volatile unsigned long  txd_timeout                   :    1;       /* [6] */
  volatile unsigned long  rxd_rising                    :    1;       /* [5] */
  volatile unsigned long  rxd_falling                   :    1;       /* [4] */
  volatile unsigned long  transmit                      :    1;       /* [3] */
  volatile unsigned long  receive                       :    1;       /* [2] */
  volatile unsigned long  evt_meas                      :    1;       /* [1] */
  volatile unsigned long  evt_break                     :    1;       /* [0] */
#else
...
// Instance base address BASE_ADDR_SCI 0x01C0U ... LIN SCI (UART) Module
...
#define RES_SCI_MEAS_CONTROL                                 (0x2810U)
...
#define RES_SCI_LIN_CONFIGURATION                            (0x1fU)
