...
typedef struct {
  ...
  volatile unsigned long  password                      :    8;       /* [15:8] */
  volatile unsigned long  reserved7                     :    6;       /* [ 7:2] */
  volatile unsigned long  restart                       :    1;       /* [1] */
  volatile unsigned long  run_enable                    :    1;       /* [0] */
#else
  volatile unsigned short run_enable                    :    1;       /* [0] */
  volatile unsigned short restart                       :    1;       /* [1] */
  volatile unsigned short reserved7                     :    6;       /* [ 7:2] */
  volatile unsigned short password                      :    8;       /* [15:8] */
#endif
...
typedef struct {
  ...
  volatile unsigned long  enable                        :    1;       /* [4] */
  volatile unsigned long  size                          :    4;       /* [ 3:0] */
#else
  volatile unsigned short size                          :    4;       /* [ 3:0] */
  volatile unsigned short enable                        :    1;       /* [4] */
...
typedef struct {
  volatile wdog_control_t                          control;                        /* 0 */
  volatile wdog_window_t                           window;                         /* 2 */
  volatile wdog_prescaler_t                        prescaler;                      /* 4 */
  volatile wdog_reload_t                           reload;                         /* 6 */
  volatile wdog_counter_t                          counter;                        /* 8 */
  unsigned short                                   reserved0[19];
  volatile wdog_irq_status_t                       irq_status;                    /* 48 */
  unsigned short                                   reserved1[1];
  volatile wdog_irq_mask_t                         irq_mask;                      /* 52 */
  unsigned short                                   reserved2[1];
  volatile wdog_irq_venable_t                      irq_venable;                   /* 56 */
  volatile wdog_irq_vdisable_t                     irq_vdisable;                  /* 58 */
  volatile wdog_irq_vmax_t                         irq_vmax;                      /* 60 */
  volatile wdog_irq_vno_t                          irq_vno;                       /* 62 */
} _PACKED_ wdog_t;
